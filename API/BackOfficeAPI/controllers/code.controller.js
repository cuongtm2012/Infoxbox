...
exports.editCode = async function (req, res) {
    ...
    var SQL = 'UPDATE TB_ITCODE SET  CODE_NM = :codeNm, CODE_NM_EN = :codeNmEn, PRT_CD_CLASS = :prtCdClass, PRT_CODE = :prtCd, SYS_DTIM = :sysDt, WORK_ID = :workID WHERE CODE = :code AND CD_CLASS = :codeClass AND VALID_START_DT = :validStartDt , VALID_END_DT = :validEndDt ';
    let params = {
        code: { val: code },
        codeClass: { val: codeClass },
        validStartDt: { val: validStartDt },
