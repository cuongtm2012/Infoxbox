...
var RESCODEEXT = {
    ...
    SearchDateFromEarlier93Days: { value: 43, name: "searchDateFrom should not be earlier than 93days before today", code: "F043" },
    TypeNumberErrorSearchDateFrom: { value: 44, name: "searchDateFrom type check error", code: "F044" },
    TypeNumberErrorSearchDateTo: { value: 44, name: "searchDateTo type check error", code: "F044" },
