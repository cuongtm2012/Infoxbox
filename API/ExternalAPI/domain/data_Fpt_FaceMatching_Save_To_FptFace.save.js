...
module.exports = function dataFptFaceMatchingSaveToFptFace(req,NICE_SSIN_ID, REQUEST_ID, data) {
    ...
    this.SOURCE_IMAGE = convertImageToBase64(path.join(pathToSaveImg, req.files.sourceImage[0].filename));
    this.TARGET_IMAGE = convertImageToBase64(path.join(pathToSaveImg, req.files.targetImage[0].filename));
