                    ...
                    resultValue1 => {
                        ...
                        cicExternalService.insertDataReqToSCRPLOG(dataInsertToScrapLog).then(
                            result => {
                                ...
                                // get token
                                httpClient.superagentPost(URI.URL_FPT_PROD_GetAuth, body).then(
                                    resultGetAuth => {
                                        if (resultGetAuth.data.ErrorCode === 0) {
                                            ...
                                            // call to fpt V01
                                            httpClient.superagentPostMultipartV01(URI.URL_FPT_PROD_V01, token, requestIdV01, req.body.idType, req.body.frontImage, req.body.idType.toUpperCase() === 'ID' ? req.body.rearImage : '').then(
                                                responseV01 => {
                                                    if (responseV01.data.ErrorCode === 0) {
                                                        ...
                                                        // call to fpt V02
                                                        httpClient.superagentPostMultipartV02(URI.URL_FPT_PROD_V02, token, requestIdV02, req.body.frontImage, req.body.selfieImage).then(
                                                            resultV02 => {
